        ...
        <div className="timetable-container">
            ...
            <div className="print-only">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style={{ textAlign: 'center' }}>
                                ...
                                <h2 style={{ fontSize: 16, margin: '5px 0 0', textDecoration: 'underline' }}>INDIVIDUAL FACULTY TIME TABLE</h2>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <table style={{ width: '100%', marginBottom: 8, fontSize: 12, fontWeight: 'bold' }}>
                    <tbody>
                        <tr>
                            <td style={{ width: '50%' }}>Faculty Name: {facultyName.toUpperCase()}</td>
                            <td style={{ width: '50%', textAlign: 'right' }}>Department: CSE</td>
                        </tr>
                    </tbody>
                </table>
